                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="project-details-thumb">
                                                <Image src={`/assets/img/portfolio/${thumbFull}`} alt="Image Not Found" width={1500} height={700} />
                                            </div>
                                        </div>
                                        <div className="col-lg-10 offset-lg-1">
                                            <div className="project-details-main-info">
                                                <div className="project-single-tags">
                                                    <Link href="#" scroll={false}>UX Design</Link>
                                                    <Link href="#" scroll={false}>Web Design</Link>
                                                </div>

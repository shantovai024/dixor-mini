                    ...
                    {BannerV4Data.bannerThumb.map(data => (
                        <SwiperSlide className="swiper-slide" key={data.id}>
                            <div className="banner-style-four-item">
                                <Image src={`/assets/img/portfolio/${data.thumbFirst}`} alt="Image Not Found" width={800} height={600} />
                                <Image src={`/assets/img/portfolio/${data.thumbLast}`} alt="Image Not Found" width={800} height={800} />
                            </div>
                        </SwiperSlide>
                    ))}
                </div>

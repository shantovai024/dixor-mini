...
const BannerV12Light = () => {
    return (
        <>
            <div className="full-slider-two-area overflow-hidden bg-cover"
                style={{ backgroundImage: 'url(/assets/img/shape/13.jpg)' }}>
                <Swiper

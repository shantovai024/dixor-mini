    ...
    return (
        <>
            {AccordionV1Data.map(data =>
                ...
                <div className="popup-single-modal modal fade" id={data.modalId} tabIndex={-1} aria-hidden="true" key={data.id}>
                                        ...
                                        <div className="row">
                                            <div className="col-lg-12">
                                                <div className="project-details-thumb">
                                                    <Image src={`/assets/img/portfolio/${data.thumbFull}`} alt="Image Not Found" width={1600} height={850} />
                                                </div>
                                            </div>
